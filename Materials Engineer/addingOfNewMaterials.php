                    ...
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-category-tab" data-toggle="tab" href="#nav-category"
                                role="tab" aria-controls="nav-category" aria-selected="true">ADD NEW CATEGORY</a>
                            <a class="nav-item nav-link" id="nav-unit-tab" data-toggle="tab" href="#nav-unit"
                                role="tab" aria-controls="nav-unit" aria-selected="false">ADD NEW UNIT</a>
                ...
                <div class="adding-of-materials-content">
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show adding-of-materials-container" id="nav-unit"
                            role="tabpanel" aria-labelledby="nav-unit-tab">
                            <form class="needs-validation" novalidate action="../server.php" method="POST">
                                <table class="table new-category-table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                ...
                                <table class="table view-inventory-tabs-table table-striped table-bordered display"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $row[1];?></td>
                                            <td><input type="button" class="btn btn-md btn-info"
                                                    value="Edit" /></td>
                                        </tr>
                                        <?php
                                            }

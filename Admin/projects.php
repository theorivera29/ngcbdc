...
=======
        <div class="container">
            <div class="row">
                <div class="col-lg-12 project-tabs">
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    ...
                                    <div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button type="button" class="btn btn-danger" name="close_project"
                                                data-toggle="modal" data-target="#close-proj-modal-<?php echo $row[4]?>">Close
                                                Project</button>
                                        </div>
                                    </div>

                                    <!-- Close Modal -->
                                    <div class="modal fade" id="close-proj-modal-<?php echo $row[4]?>" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"></h5>
                                                    <h4>Are you sure you want to close <?php echo $row[0] ;?>?</h4>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="../server.php" method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        ?>
                                                        <label class="label-styles">Materials Engineer
                                                            Involved</label>
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="submit" name="edit_project"
                                ...
                                <form action="../server.php" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-success" name="reopen_project"
                                            data-toggle="modal" data-target="#reopen-proj-modal-<?php echo $row[4]?>">Re-Open
                                            Project</button>
                                        <button type="button" class="btn btn-danger" name="delete_project" 
                                            data-toggle="modal" data-target="#delete-proj-modal-<?php echo $row[4]?>">Delete
                                            Project</button>
                                    </div>
                                    <!-- Reopen Modal -->
                                    <div class="modal fade" id="reopen-proj-modal-<?php echo $row[4]?>" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"></h5>
                                                    <h4>Are you sure you want to re-open <?php echo $row1[0] ;?>?</h4>
                                                    </button>
                                                </div>
                                                <div class="modal-footer">
                                    ...
                                    <!-- End of Reopen Modal -->
                                    <!-- Delete Modal -->
                                    <div class="modal fade" id="delete-proj-modal-<?php echo $row[4]?>" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"></h5>
                                                    <h4>Are you sure you want to delete <?php echo $row1[0] ;?>?</h4>
                                                    </button>
                                                </div>
                                                <div class="modal-footer">
